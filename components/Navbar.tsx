        ...
        <div className="hidden md:flex items-center justify-between max-w-7xl mx-auto px-8 pt-3 pb-5">
          ...
          <div className="shrink-0">
            <Magnetic strength={12}>
              <Link
                href="/contact"
                className="border border-[#1E00FF] shadow-[0_0_25px_rgba(30,0,255,0.35)] text-white text-sm font-semibold px-7 py-3 rounded-2xl hover:bg-blue-600/10 transition-all duration-300 whitespace-nowrap block"
              >
                Let&apos;s Talk
              </Link>
            </Magnetic>
