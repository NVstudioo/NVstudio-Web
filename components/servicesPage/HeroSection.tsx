export default function HeroSection() {
  return (
    <section
      ...
      className="relative min-h-[440px] bg-black/50 h-screen bg-cover bg-center max-[640px]:bg-[center_top] flex flex-col items-center justify-center text-center px-6 py-24 overflow-hidden"
    >
      <div
        style={{
          position: "absolute",
      ...
      <div className="relative z-10 max-w-lg">
        <h1 className="text-responsive-hero text-[#EDEDED]">
          Our Services
        </h1>
